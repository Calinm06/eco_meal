 ...
 */
final class Version20260702075128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE business (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, city VARCHAR(50) NOT NULL, street VARCHAR(50) NOT NULL, house_number VARCHAR(10) DEFAULT NULL, phone_number VARCHAR(20) NOT NULL, business_type_id INT NOT NULL, INDEX IDX_8D36E38987F37DE (business_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, package_id_id INT NOT NULL, consumer_id INT NOT NULL, UNIQUE INDEX UNIQ_F5299398EA4099B0 (package_id_id), INDEX IDX_F529939837FDBD6D (consumer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE package (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, name VARCHAR(100) NOT NULL, price DOUBLE PRECISION NOT NULL, photo VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, category_id INT NOT NULL, business_id INT DEFAULT NULL, INDEX IDX_DE68679512469DE2 (category_id), INDEX IDX_DE686795A89DB457 (business_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398EA4099B0 FOREIGN KEY (package_id_id) REFERENCES package (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F5299398EA4099B0');
